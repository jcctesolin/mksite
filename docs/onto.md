...
[:link:{ title="IRI"}](https://purl.org/s2c2/hint)
[:material-library:{title="Vocabulary"}](vocab/hintvocab.md)
...
[:link:{ title="IRI"}](https://purl.org/s2c2/qvas)
[:material-library:{title="Vocabulary"}](vocab/qvasvocab.md)
...
IRI : [https://purl.org/s2c2/miscon](https://purl.org/s2c2/miscon)
Vocabulário :
